<x-layout>
    <x-title>
        <h1 class="font-semibold text-3xl text-white">Edit Artikel</h1>
    </x-title>
        ...
        <form method="POST" action="{{ route('articles.update', $article->id) }}">
            ...
            <div class="mb-6">
                ...
                <textarea name="content" rows="6" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200">{{ $article->content }}</textarea>
            </div>
